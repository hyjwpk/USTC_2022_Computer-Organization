...
HD_PWD='C:/Users/wangc/OneDrive - mail.ustc.edu.cn/Study/Cs/cod/lab/lab6/lab6/lab6.runs/dist_mem_gen_2_BTB_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dist_mem_gen_2_BTB.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dist_mem_gen_2_BTB.tcl
